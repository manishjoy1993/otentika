 ...
 * Login data helper
 */
namespace Excellence\Login\Helper;
...
{
    /**
     * Path to store config where count of login posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'login/view/items_per_page';
    ...
    /**
     * Remove Login item image by image filename
     *
    ...
    /**
     * Return URL for resized Login Item Image
     *
     * @param Excellence\Login\Model\Login $item
     * @param integer $width
     * @param integer $height
     * @return bool|string
     */
    public function resize(\Excellence\Login\Model\Login $item, $width, $height = null)
    {
        if (!$item->getImage()) {
            return false;
        }
    ...
    /**
     * Return the base media directory for Login Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Login Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getLoginPerPage()
    {
