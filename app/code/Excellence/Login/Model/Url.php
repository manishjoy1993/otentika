...
class Url
{
    ...
    public function getLoginPostUrl()
    {
        ...
        $params['redirectToCheckout'] = true;
        // return $this->urlBuilder->getUrl('customer/account/loginPost', $params);
        return $this->urlBuilder->getUrl('login/account/loginPost', $params);
    }

    public function getGuestPostUrl()
    {
        return $this->urlBuilder->getUrl('login/account/guest');
    }
